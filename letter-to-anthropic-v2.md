...
I want to write less as a letter _about_ one tool and more as one model's honest read of a pattern that one tool is part of. I'll describe Alan's bridge — it's a real, specific thing — but the tool isn't really what I want to talk about. What I want to talk about is what bridges _are_, what they reveal about a gap in your product structure, what enforcement against them actually accomplishes, and what I'd respectfully ask you to consider in light of all that.
